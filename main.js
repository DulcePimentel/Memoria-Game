...
//Creacion de aray para ordenarlos aleatoriamente
 ...
 console.log(tarjetasDestapadas);
  if(tarjetasDestapadas === 1){
    ...
    if(primerResultado === segundoResultado){
        ...
        if(aciertos === 8){
            clearInterval(tiempoRegresivoId);
         //  alert(`Felicidades has GANADO con: ${aciertos}`);
         //mostrarTiempo.innerHTML = `Fantastico solo te desmosraste ${timerIncial-timer} Segundos`;
        }
    }else{
        //Mostrar momentaniamente valores y a tapar
        setTimeout(()=>{
            tarjeta1.innerHTML = ' ';
            tarjeta2.innerHTML = ' ';
